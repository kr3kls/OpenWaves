...
def create_app():
    ...
    def set_csp_header(response):
        # Content Security Policy with violation reporting and support for inline styles
        # with a nonce
        csp = (
            ...
            # Allow inline styles with nonce and external styles
            f"style-src 'self' 'nonce-{g.csp_nonce}' https://cdnjs.cloudflare.com; "  
